 ...
 */
struct FBBBCharacterInputFrame final
{
    TBBBCharacterInputSlot<FBBBRestoreEquipmentPacket> RestoreEquipment;
    TBBBCharacterInputSlot<FBBBRestoreAimPacket> RestoreAim;
    TBBBCharacterInputSlot<FBBBRestoreLocomotionPacket> RestoreLocomotion;
    ...
    void Submit(FBBBRestoreEquipmentPacket Packet)
    {
        RestoreEquipment.Submit(MoveTemp(Packet));
    }

    void Submit(FBBBRestoreAimPacket Packet)
    {
        RestoreAim.Submit(MoveTemp(Packet));
    }

    void Submit(FBBBRestoreLocomotionPacket Packet)
    {
        RestoreLocomotion.Submit(MoveTemp(Packet));
    }
