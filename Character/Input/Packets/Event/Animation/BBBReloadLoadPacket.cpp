...
bool FBBBReloadLoadPacket::CanApply(const FBBBCharacterPacketContext &Context) const
{
    // 还原模式不由本地动画通知驱动换弹阶段
    return !Context.Operation.IsRestoreMode();
}

void FBBBReloadLoadPacket::Apply(FBBBCharacterPacketContext &Context) const
{
