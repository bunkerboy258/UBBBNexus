...
bool FBBBMagazineDetachedFactPacket::CanExecute(const FBBBCharacterPacketContext &Context) const
{
    return true;
}

void FBBBMagazineDetachedFactPacket::Execute(FBBBCharacterPacketContext &Context) const
{
