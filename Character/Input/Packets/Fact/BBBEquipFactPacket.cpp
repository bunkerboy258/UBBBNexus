...
bool FBBBEquipFactPacket::CanApply(const FBBBCharacterPacketContext &Context) const
{
    return true;
}

void FBBBEquipFactPacket::Apply(FBBBCharacterPacketContext &Context) const
{
