...
#include "BBBMontagePlayback.generated.h"
class ABBBCharacter;

/** 保存每次换弹播放身份并转发标准蒙太奇通知 */
UCLASS()
class UBBBMontagePlayback final : public UObject
{
    GENERATED_BODY()
...
public:
     ...
     * @return 无
     */
    void Start(UAnimInstance &AnimInstance, UAnimMontage &Montage, float PlayRate, int32 InSequence, uint64 InRevision, bool bInReload);
