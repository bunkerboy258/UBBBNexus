...
ABBBCharacterInstance::ABBBCharacterInstance()
{
    //启用帧更新
...
void ABBBCharacterInstance::BeginPlay()
{
    Super::BeginPlay();
...
void ABBBCharacterInstance::Tick(float DeltaSeconds)
{
...
void ABBBCharacterInstance::RegisterActorTickFunctions(bool bRegister)
{
...
bool ABBBCharacterInstance::ShouldReplicateAcceleration() const
{
    return true;
}
...
void ABBBCharacterInstance::LateUpdate()
{
    CharacterUpdatePipeline.LateUpdate();
}

void ABBBCharacterInstance::SetupPlayerInputComponent(UInputComponent *PlayerInputComponent)
{
