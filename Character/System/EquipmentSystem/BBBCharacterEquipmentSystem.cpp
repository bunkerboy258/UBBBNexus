...
void FBBBCharacterEquipmentSystem::RemoveMagazinePresentation()
{
    if (!EquipmentData)
    {
        return;
    ...
    UBBBEquipmentInstance *ActiveInstance = EquipmentData->Equipment.GetActiveMainHandInstance();
    UBBBEquipmentSystem *ActiveEquipmentSystem = ActiveInstance
        ? ActiveInstance->GetEquipmentSystem()
        : nullptr;

    if (ActiveEquipmentSystem)
    {
        ActiveEquipmentSystem->RemoveMagazinePresentation();
    }
}

//------------------------------------------------------------------------------

void FBBBCharacterEquipmentSystem::SpawnMagazinePresentation()
{
    if (!EquipmentData)
    {
        return;
    ...
    if (ActiveEquipmentSystem)
    {
        ActiveEquipmentSystem->SpawnMagazinePresentation();
    }
}
