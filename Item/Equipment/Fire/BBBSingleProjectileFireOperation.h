...
#include "BBBSingleProjectileFireOperation.generated.h"
...
class ABBB_EVAC_API UBBBSingleProjectileFireOperation final : public UBBBFireOperation
{
    GENERATED_BODY()

public:
    /** 构造单投射物开火配置 */
    UBBBSingleProjectileFireOperation();

    //~ Begin UBBBFireOperation Interface
    virtual bool Fire(ABBBEquipmentActor &EquipmentActor, UBBBFireRuntimeData &RuntimeData) const override;
    virtual void Present(ABBBEquipmentActor &EquipmentActor) const override;
    //~ End UBBBFireOperation Interface
