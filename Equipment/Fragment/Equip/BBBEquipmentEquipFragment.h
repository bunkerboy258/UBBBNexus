...
struct ABBB_EVAC_API FBBBEquipmentEquipFragment
{
    ...
    /**
     * @param Context 挂接所需的装备和角色事实
     * @return 挂接是否成功
     */
    virtual bool Activate(FBBBEquipmentEquipContext &Context) const
    {
        return false;
    }
     ...
     * @return 装备表现是否已提交
     */
    virtual bool SubmitMontage(FBBBCharacterExternalAPI &CharacterAPI, int32 Sequence) const
    {
        return false;
    }
