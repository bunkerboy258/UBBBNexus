...
struct ABBB_EVAC_API FBBBEquipmentFireFragment
{
    ...
    /** 弹药容量 */
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "BBB|Equipment|Fire|Ammo", meta = (ClampMin = "1"))
     ...
     * @return 是否允许开火
     */
    virtual bool CanFire(int32 LoadedAmmo, float LastFireTimeSeconds, float WorldTime) const
    {
        return false;
    }
